...
class AlertAdmin(ModelView, model=Alert):
    ...
    column_details_exclude_list = [Alert.location] # Exclude raw location data from detail view
...
class AdminReviewAdmin(ModelView, model=AdminReview):
    column_list = [AdminReview.alert_id, AdminReview.admin, AdminReview.vote, AdminReview.created_at]
    name = "Admin Review"
    name_plural = "Admin Reviews"
    icon = "fa-solid fa-check-to-slot"

class WarningAdmin(ModelView, model=Warning):
    column_list = [Warning.id, Warning.user, Warning.reason, Warning.issuer, Warning.created_at]
    name = "Warning"
    name_plural = "Warnings"
    icon = "fa-solid fa-gavel"

class FeaturedItemAdmin(ModelView, model=FeaturedItem):
    column_list = [FeaturedItem.id, FeaturedItem.title, FeaturedItem.user, FeaturedItem.created_at, FeaturedItem.expires_at]
    name = "Featured Item"
